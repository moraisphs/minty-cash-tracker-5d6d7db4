      ...
      <div className="mx-auto max-w-7xl space-y-4 xs:space-y-6">
        ...
        <div className="flex flex-col xs:flex-row xs:items-center xs:justify-between gap-3 xs:gap-4">
          <div className="text-center xs:text-left">
            <h1 className="text-xl xs:text-2xl sm:text-3xl font-bold bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">
              My Cash
            </h1>
        ...
        <div className="text-center space-y-3 xs:space-y-4">
          <div className="space-y-1 xs:space-y-2">
            <h2 className="text-lg xs:text-xl sm:text-2xl font-bold">Visão Geral Financeira</h2>
            <p className="text-xs xs:text-sm sm:text-base text-muted-foreground">Acompanhe seus gastos e receitas</p>
          </div>
          <div className="max-w-sm xs:max-w-md mx-auto px-2 xs:px-4">
